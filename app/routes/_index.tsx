        ...
        <>
            <div className={'min-h-[100vh] bg-[#037D97] grid grid-cols-[3.8fr_6.2fr]'}>
                <div className={'flex flex-col justify-between p-14'}>
                    ...
                    <div className={''}>
                        <p className={'text-cyan-200'}>&lsquo;Sup? My name is </p>
            ...
            <div>
                <h2 className={'text-4xl px-12 py-24'}>Industry Experience.</h2>
                <div></div>
            </div>
            <div>
                <h2 className={'text-4xl px-12 py-24'}>Technical Experience.</h2>
                <div></div>
            </div>
            <div>
                <h2 className={'text-4xl px-12 py-24'}>Causes.</h2>
                <div></div>
            </div>
        </>
    );
