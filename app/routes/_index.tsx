...
function CityIllustration() {
    return (
        <div className={'mt-16'}>
            <img className={'p-7 mb-12 lg:max-w-[750px] m-auto'} src={'city.svg'} alt={'city illustration'}/>
            <Capsule>
...
function About() {
    return (
        <div>
            <Section title={'Designer at Heart'} backgroundColor={'bg-rose-900'} textColor={'text-rose-50'}>
                ...
                <p>As I’ve navigated the world of design since then, I’ve become especially drawn to the Japanese
                    concept of Ma or minimalism. From interior design to apps, I firmly believe less is more.
                    Calming
            ...
            <Section title={'Finding Purpose'} backgroundColor={'bg-teal-900'} textColor={'text-teal-50'}>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vehicula leo lectus, ut consectetur
                    diam consequat ut. Fusce dignissim fringilla nisi ac auctor. Mauris malesuada, lectus a
                    malesuada
                    posuere, leo ipsum tincidunt diam, eget pulvinar urna velit vel risus. Maecenas eu enim quam.
                    Morbi
                ...
                <p>Pellentesque facilisis lacus nibh, ut posuere mauris sagittis quis. Maecenas nec
                    ullamcorper tellus, ac aliquet lacus. Vivamus egestas, tortor et egestas sollicitudin, elit
                    lorem
                    laoreet metus, quis suscipit est ligula in arcu. Duis id varius dolor. In vestibulum
                    sollicitudin
                    magna
